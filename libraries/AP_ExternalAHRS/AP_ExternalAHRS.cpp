...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Bitmask: 0:Vector Nav use uncompensated values for accel gyro and mag.,1:Enable calibration of IL INS,2:Use IL INS baro altitude,3:Use IL INS airspeed and wind estimation,4:Translate static and diff pressure to ILabs
    // @User: Standard
